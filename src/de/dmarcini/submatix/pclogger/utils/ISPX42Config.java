...
public interface ISPX42Config
{
   ...
   * 
   * Stand: 07.01.2012
   * @param conf zu vergleichende Konfiguration
   * @return gleichheit 
   */
   ...
   * 
   * Stand: 07.01.2012
   * @param wasInit Ist das Objekt gültig
   */
   ...
   * 
   * Stand: 07.01.2012
   * @param gfLow LOW-Wert GDeco-Gradient
   * @param gfHigh HIGH-Wert Deco-Gradient
   */
   ...
   * 
   * Stand: 07.01.2012
   * @param gfLow LOW-Wert Deco gradient
   */
   ...
   * 
   * Stand: 07.01.2012
   * @param gfHith HIGH-Wert Deco-Gradient
   */
   ...
   * 
   * Stand: 07.01.2012
   * @param preset Nummer des Presets
   */
   ...
   * 
   * Stand: 07.01.2012
   * @param lastStop 0 == 3 Meter, 1 == 6 Meter
   */
   ...
   * 
   * Stand: 07.01.2012
   * @param enabled erlaubt/unterbunden
   */
   ...
   * 
   * Stand: 08.01.2012
   * @param enabled erlauben/unterbinden
   */
   ...
   * 
   * Stand: 08.01.2012
   * @param bright Helligkeit (10%, 50%, 100%)
   * @param orient Quer/108 Grad
   */
   ...
   * 
   * Stand: 08.01.2012
   * @param fromSpx Steuerstring vom SPX42
   ...
   * 
   * Stand: 08.01.2012
   * @param brightness Helligkeit (0==10%, 1==50%, 2==100%)
   */
