...
{                                                                                                                                    /**
  ...
  private void initPanel()
  {
    ...
    decompressionPanel
            .setBorder(new TitledBorder(new LineBorder(new Color(128, 128, 128), 1, true), "Deco", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    setpointPanel
            .setBorder(new TitledBorder(new LineBorder(new Color(128, 128, 128), 1, true), "Setpoint", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    individualPanel.setBorder(new TitledBorder(new LineBorder(new Color(128, 128, 128), 1, true), "Individuals", TitledBorder.LEADING, TitledBorder.TOP, null,
            null));
  ...
  public int setLanguageStrings(ResourceBundle stringsBundle)
  {
    ...
    try
    {
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.decoLastStopComboBox.3m.text"),
              stringsBundle.getString("spx42ConfigPanel.decoLastStopComboBox.6m.text") };
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.decoDyngradientsLabel.vconservative.text"),
              stringsBundle.getString("spx42ConfigPanel.decoDyngradientsLabel.conservative.text"),
              stringsBundle.getString("spx42ConfigPanel.decoDyngradientsLabel.moderate.text"),
              stringsBundle.getString("spx42ConfigPanel.decoDyngradientsLabel.aggressive.text"),
              stringsBundle.getString("spx42ConfigPanel.decoDyngradientsLabel.vaggressive.text"),
              stringsBundle.getString("spx42ConfigPanel.decoDyngradientsLabel.custom.text") };
      portBoxModel = new DefaultComboBoxModel(entrys);
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.autoSetpointComboBox.off.text"),
              stringsBundle.getString("spx42ConfigPanel.autoSetpointComboBox.5m.text"),
              stringsBundle.getString("spx42ConfigPanel.autoSetpointComboBox.10m.text"),
              stringsBundle.getString("spx42ConfigPanel.autoSetpointComboBox.15m.text"),
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.highSetpointComboBox.10.text"),
              stringsBundle.getString("spx42ConfigPanel.highSetpointComboBox.11.text"),
              stringsBundle.getString("spx42ConfigPanel.highSetpointComboBox.12.text"),
              stringsBundle.getString("spx42ConfigPanel.highSetpointComboBox.13.text"),
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.displayBrightnessComboBox.10.text"),
              stringsBundle.getString("spx42ConfigPanel.displayBrightnessComboBox.50.text"),
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.displayOrientationComboBox.landscape.text"),
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.unitsTemperatureComboBox.celsius.text"),
              stringsBundle.getString("spx42ConfigPanel.unitsTemperatureComboBox.fahrenheit.text") };
      portBoxModel = new DefaultComboBoxModel(entrys);
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.unitsDepthComboBox.metrical.text"),
              stringsBundle.getString("spx42ConfigPanel.unitsDepthComboBox.imperial.text") };
      portBoxModel = new DefaultComboBoxModel(entrys);
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.unitsSalnityComboBox.saltwater.text"),
              stringsBundle.getString("spx42ConfigPanel.unitsSalnityComboBox.clearwater.text") };
      portBoxModel = new DefaultComboBoxModel(entrys);
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.individualsSensorwarnComboBox.1.text"),
              stringsBundle.getString("spx42ConfigPanel.individualsSensorwarnComboBox.2.text"),
      ...
      entrys = new String[] { stringsBundle.getString("spx42ConfigPanel.individualsLogintervalComboBox.10s.text"),
