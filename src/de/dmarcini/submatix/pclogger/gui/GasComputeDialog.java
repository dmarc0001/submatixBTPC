...
public class GasComputeDialog extends JDialog implements ActionListener, ChangeListener, ItemListener
{
   ...
   * @param unitsString
   */
  public GasComputeDialog(ResourceBundle stringsBundle, String unitsString)
  {
  ...
  private void initDialog()
  {
    ...
    panel.setBorder(new TitledBorder(null, stringsBundle.getString("GasComputeDialog.gasdef.title"), TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0,
            0, 128)));
    JPanel panel_1 = new JPanel();
    panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), stringsBundle.getString("GasComputeDialog.computed.title"),
            TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 128)));
    JPanel panel_2 = new JPanel();
    panel_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), stringsBundle.getString("GasComputeDialog.fordepthcompute.title"),
                            ...
                            gl_contentPanel
                                    ...
                                    .addGroup(
                                            gl_contentPanel.createSequentialGroup()
                                                    .addComponent(panel, GroupLayout.PREFERRED_SIZE, 252, GroupLayout.PREFERRED_SIZE).addGap(18)
                            ...
                            gl_panel_2
                                    ...
                                    .addGroup(
                                            gl_panel_2.createSequentialGroup()
                                                    .addComponent(advisedDepthLabel, GroupLayout.PREFERRED_SIZE, 128, GroupLayout.PREFERRED_SIZE).addGap(18)
                                                    .addComponent(advisedDepthSpinner, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
                                                    ...
                                                    .addComponent(pressureUnitLabel2, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE)))
                    .addContainerGap()));
                            ...
                            gl_panel_2
                                    ...
                                    .addGroup(
                                            gl_panel_2
                                                    ...
                                                    .addComponent(advisedDepthLabel)
                                                    .addComponent(advisedDepthSpinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                            GroupLayout.PREFERRED_SIZE).addComponent(advisedDepthUnitLabel))
                                    .addGroup(
                                            gl_panel_2
                                                    .createParallelGroup(Alignment.LEADING)
                                                    ...
                                                    .addGroup(
                                                            gl_panel_2
                                                                    .createSequentialGroup()
                                                                    .addGap(2)
                                                                    .addComponent(pressureUnitLabel2, GroupLayout.PREFERRED_SIZE, 16,
                                                                            GroupLayout.PREFERRED_SIZE)))).addPreferredGap(ComponentPlacement.UNRELATED)
                    .addComponent(advisedDepthEadLabel).addContainerGap(14, Short.MAX_VALUE)));
                            ...
                            gl_panel_1
                                    ...
                                    .addGroup(
                                            gl_panel_1.createSequentialGroup()
                                                    .addComponent(partialPressureComboBox, GroupLayout.PREFERRED_SIZE, 169, GroupLayout.PREFERRED_SIZE)
            ...
            gl_panel.createSequentialGroup()
                    ...
                    .addGroup(
                            gl_panel.createParallelGroup(Alignment.LEADING)
                                    ...
                                    .addGroup(
                                            gl_panel.createSequentialGroup()
                                                    .addComponent(heliumSpinner, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
                                                    .addPreferredGap(ComponentPlacement.RELATED)
                                                    .addComponent(label_4, GroupLayout.PREFERRED_SIZE, 10, GroupLayout.PREFERRED_SIZE))
                                    .addGroup(
                                            gl_panel.createSequentialGroup()
                                                    .addComponent(oxygenSpinner, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE)
            ...
            gl_panel.createSequentialGroup()
                    ...
                    .addGroup(
                            gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(label)
                                    .addComponent(oxygenSpinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                    ...
                                                    .addGroup(
                                                            gl_panel.createParallelGroup(Alignment.BASELINE)
                                                                    .addComponent(nitrogenSpinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                                            GroupLayout.PREFERRED_SIZE).addComponent(label_2))))
    ...
    contentPanel.setLayout(gl_contentPanel);
    {
      ...
      gl_buttonPane.setHorizontalGroup(gl_buttonPane.createParallelGroup(Alignment.LEADING).addGroup(
              gl_buttonPane.createSequentialGroup().addContainerGap()
                      .addComponent(gasDescriptionLabel, GroupLayout.PREFERRED_SIZE, 276, GroupLayout.PREFERRED_SIZE).addGap(116).addComponent(buttonClose)
                      .addContainerGap()));
  ...
  public void setDescriptionForGas(int o2, int he)
  {
    ...
    if (unitsString.equals("metric"))
    {
      ...
      bailoutGasValsLabel.setText(String.format(stringsBundle.getString("spx42GaslistEditPanel.mod-ead-label.metric"), Math.round(bailoutMOD),
              Math.round(bailoutEAD)));
    ...
    else
    {
      ...
      bailoutGasValsLabel.setText(String.format(stringsBundle.getString("spx42GaslistEditPanel.mod-ead-label.imperial"), Math.round(bailoutMOD),
              Math.round(bailoutEAD)));
