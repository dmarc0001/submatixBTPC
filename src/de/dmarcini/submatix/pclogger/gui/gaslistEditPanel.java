...
{  //
   ...
   * @param logger
   */
  public gaslistEditPanel( Logger logger )
  {
    if( logger == null )
    {
  ...
  public void initPanel()
  {
    ...
    gasReadFromSPXButton.setIcon( new ImageIcon( gaslistEditPanel.class.getResource( "/de/dmarcini/submatix/pclogger/res/Download.png" ) ) );
    ...
    gasWriteToSPXButton.setIcon( new ImageIcon( gaslistEditPanel.class.getResource( "/de/dmarcini/submatix/pclogger/res/Upload.png" ) ) );
