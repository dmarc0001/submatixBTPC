...
{  //
  ...
  private void initPanel()
  {
    ...
    deleteGasPresetButton = new JButton("DELETESELECT");
  ...
  public int setLanguageStrings(ResourceBundle stringsBundle)
  {
    ...
    try
    {
      ...
      deleteGasPresetButton.setText(stringsBundle.getString("spx42GaslistEditPanel.gasPanel.deleteGasPresetButton.text"));
      deleteGasPresetButton.setToolTipText(stringsBundle.getString("spx42GaslistEditPanel.gasPanel.deleteGasPresetButton.tooltiptext"));
